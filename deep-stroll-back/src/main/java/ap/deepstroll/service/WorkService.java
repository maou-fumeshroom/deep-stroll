...
public  abstract class WorkService {
     ...
     * @return
     */
    public   List browseWork(String title,String labels,Integer classifyId,Integer state,Integer likeNum,Integer startIndex,Integer pageSize){return null;}
     ...
     * @return
     */
    public  Integer Publish(Work work){return null;}
