<template>
  <div class="oder">
    <div style="width:96%;height:120px;margin: 20px auto;background-color:#FFFFFF">
      ...
      <div style="margin:0 20px;border-top:1px solid #EFEEEE">
        ...
        <div style="margin:15px 20px;">
          ...
          <span style="color:#707070;font-size:14px;">标签类别：</span>
          ...
          <span style="color:#707070;font-size:14px;margin-left:10px;">标签所属：</span>
    ...
    <div style="width:96%;margin: 20px auto;background-color:#FFFFFF;padding-bottom:10px;position:relative;">
      <p style="color:#707070;padding:15px 20px;margin:0 20px;border-bottom:1px solid #EFEEEE">标签列表</p>
      ...
      <div>
        <el-table :data="tableData" style="width: 100%;margin:20px auto 10px auto;" stripe >
          <el-table-column label="标签编号" prop="id" align="center">
          </el-table-column>
          <el-table-column label="名称" prop="name" align="center">
          </el-table-column>
          <el-table-column label="类别" prop="status" align="center">
            <template slot-scope="scope">
              <span>{{scope.row.ishot|filters}}</span>
            </template>
          </el-table-column>
          <el-table-column label="使用次数" prop="times" align="center">
          </el-table-column>
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              <el-button @click="deleteAdmin(scope.row.id)" size="mini" round v-if="scope.row.ishot===0">设为热门</el-button>
              <el-button @click="change(scope.row.id)" size="mini" round v-else>取消热门</el-button>
            </template>
          </el-table-column>
        </el-table>
